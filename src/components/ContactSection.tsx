            ...
            <div className="space-y-8">
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-1">{t("contact.info.address.label")}</h3>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-1">{t("contact.info.phone.label")}</h3>
                    <a
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-1">{t("contact.info.email.label")}</h3>
                    <a
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-1">{t("contact.info.hours.label")}</h3>
              ...
              <div className="rounded-xl overflow-hidden h-64 bg-muted">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3821.939093848732!2d74.22271247617631!3d16.6799309840916!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc1012a8d6c6723%3A0x48d0e1dc66b5cf5b!2sSri%20Sri%20Residency!5e0!3m2!1sen!2sin!4v1767332071774!5m2!1sen!2sin"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
