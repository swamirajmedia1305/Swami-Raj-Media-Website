...
const FloatingButtons = () => {
  ...
  return (
    <>
      ...
      {/* Mobile stack: language toggle above WhatsApp */}
      <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3 md:hidden">
        <button
          onClick={toggleLanguage}
          className="w-12 h-12 rounded-2xl bg-primary text-primary-foreground shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 flex flex-col items-center justify-center"
