  ...
  return (
    <>
      ...
      <a
        ...
        className="fixed bottom-6 left-6 z-40 w-14 h-14 bg-primary rounded-full flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 md:hidden"
        aria-label="Call Now"
      >
